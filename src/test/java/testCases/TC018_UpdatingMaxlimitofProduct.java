...
public class TC018_UpdatingMaxlimitofProduct extends BaseClass{

	@Test
	public void test_VerifyUpdateMaxLimitCart()
	{
		try {
	    	...
	    	String ExpectedMaxlimit = pb.getMaxProdQuantity();
	    	pb.AddToCartItem();
	    	String ActualMaxLimit = cart.getCartQuantity();
	    	Assert.assertEquals(ExpectedMaxlimit, ActualMaxLimit,  "Cart is not updated with expected Qty Limit");
